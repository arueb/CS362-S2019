...
int main() {
  char *fName = "cardEffect_adventurer()";
  int seed = 1000;
  int numPlayer = 2;
  int handpos = 0;
  int player = 0;
  ...
  for (int test = 1; test <= 4; test++){
    ...
    int cardDrawn = testG.hand[player][testG.handCount[player]-1];//top card of hand is most recently drawn card.
    returnVal = cardEffect_adventurer(0, &testG, player, cardDrawn, 0);
